...
namespace Graphex.Test
{
    public class GraphVTests
    {
        ...
        {
            var gr = new GraphV<string, Station, Route>();
        ...
        {
            var gr = new GraphV<int, int, int>(initializeSelfNode: true);
            gr.AddNode(0);
            gr.AddNode(1);
            gr.AddNode(2);
            gr.AddNode(3);
        ...
        private void AddDejikstraEdge(GraphV<int, int, int> gr, int from, int to, double dist)
        {
